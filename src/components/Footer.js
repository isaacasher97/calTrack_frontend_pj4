...
const Footer = () => {
  ...
  <div class="container p-4 pb-0">
    ...
    <section class="mb-4">
      {/* <!-- Facebook --> */}
      <a class="btn btn-outline-light btn-floating m-1" href="https://www.facebook.com/profile.php?id=61550567973991" target='_blank' rel='noreferrer' role="button">
      ...
      {/* <!-- Youtube --> */}
      <a class="btn btn-outline-light btn-floating m-1" href="https://www.youtube.com/channel/UCwJY7bkNpYwHXJ2RFV6c1Bw" target='_blank' rel='noreferrer' role="button">
      ...
      {/* <!-- Linkedin --> */}
      <a class="btn btn-outline-light btn-floating m-1" href="https://www.linkedin.com/in/isaac-ash/" target='_blank' rel='noreferrer' role="button">
      ...
      {/* <!-- Github --> */}
      <a class="btn btn-outline-light btn-floating m-1" href="https://github.com/isaacasher97" target='_blank' rel='noreferrer' role="button">
  ...
  <div class="text-center p-3" style={{"background-color": "rgba(0, 0, 0, 0.2);"}}>
    © 2023 Developed By: 
    <a class="text-white" href="https://www.isaacasher.dev/" target='_blank' rel='noreferrer' style={{"textDecoration" : "none"}}> Isaac Asher </a>
  </div>
  {/* <!-- Copyright --> */}
</footer>
    </div>
